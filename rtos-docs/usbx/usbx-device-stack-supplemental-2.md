...
<span data-ttu-id="c3c85-180">Di seguito è riportata la descrizione di un flusso di applicazione DFU tipico.</span><span class="sxs-lookup"><span data-stu-id="c3c85-180">Following is the description of a typical DFU application flow.</span></span>
...
<span data-ttu-id="c3c85-206">La classe PIMA del dispositivo USB consente a un sistema host USB (initiator) di connettersi a un</span><span class="sxs-lookup"><span data-stu-id="c3c85-206">The USB device PIMA class allows for a USB host system (Initiator) to connect to a</span></span>
...
| <span data-ttu-id="c3c85-265">UX_DEVICE_CLASS_PIMA_EC_OBJECT_ADDED</span><span class="sxs-lookup"><span data-stu-id="c3c85-265">UX_DEVICE_CLASS_PIMA_EC_OBJECT_ADDED</span></span>             | <span data-ttu-id="c3c85-266">0x4002</span><span class="sxs-lookup"><span data-stu-id="c3c85-266">0x4002</span></span>  | <span data-ttu-id="c3c85-267">Un oggetto è stato aggiunto al supporto del dispositivo e può essere recuperato da host\.</span><span class="sxs-lookup"><span data-stu-id="c3c85-267">An object has been added to the device media and can be retrieved by the host\.</span></span> |
...
<span data-ttu-id="c3c85-323">Aggiunta di un oggetto e invio dell'evento all'host</span><span class="sxs-lookup"><span data-stu-id="c3c85-323">Adding an object and sending the event to the host</span></span>
...
- <span data-ttu-id="c3c85-358">**Pima**: puntatore all'istanza della classe Pima.</span><span class="sxs-lookup"><span data-stu-id="c3c85-358">**pima**: Pointer to the pima class instance.</span></span>
...
### <a name="prototype"></a><span data-ttu-id="c3c85-364">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-364">Prototype</span></span>
...
- <span data-ttu-id="c3c85-390">**Pima**: puntatore all'istanza della classe Pima</span><span class="sxs-lookup"><span data-stu-id="c3c85-390">**pima**: Pointer to the pima class instance</span></span>
- <span data-ttu-id="c3c85-391">**object_handle**: handle dell'oggetto</span><span class="sxs-lookup"><span data-stu-id="c3c85-391">**object_handle**: Handle of the object</span></span>
- <span data-ttu-id="c3c85-392">**fase**: fase del trasferimento (attiva o completa)</span><span class="sxs-lookup"><span data-stu-id="c3c85-392">**phase**: phase of the transfer (active or complete)</span></span>
- <span data-ttu-id="c3c85-393">**object_buffer**: Indirizzo buffer oggetto</span><span class="sxs-lookup"><span data-stu-id="c3c85-393">**object_buffer**: Object buffer address</span></span>
- <span data-ttu-id="c3c85-394">**object_offset**: indirizzo dei dati</span><span class="sxs-lookup"><span data-stu-id="c3c85-394">**object_offset**: Address of data</span></span>
- <span data-ttu-id="c3c85-395">**object_length**: lunghezza dei dati dell'oggetto inviata dall'applicazione</span><span class="sxs-lookup"><span data-stu-id="c3c85-395">**object_length**: Object data length sent by application</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-396">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-396">Example</span></span>
...
## <a name="ux_device_class_pima_object_delete"></a><span data-ttu-id="c3c85-397">ux_device_class_pima_object_delete</span><span class="sxs-lookup"><span data-stu-id="c3c85-397">ux_device_class_pima_object_delete</span></span>

<span data-ttu-id="c3c85-398">Eliminare un oggetto locale</span><span class="sxs-lookup"><span data-stu-id="c3c85-398">Delete a local object</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-399">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-399">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-400">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-400">Description</span></span>

<span data-ttu-id="c3c85-401">Questa funzione viene chiamata quando la classe PIMA deve eliminare un oggetto nella risorsa di archiviazione locale.</span><span class="sxs-lookup"><span data-stu-id="c3c85-401">This function is called when the PIMA class needs to delete an object on the local storage.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-402">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-402">Parameters</span></span>

- <span data-ttu-id="c3c85-403">**Pima**: puntatore all'istanza della classe Pima</span><span class="sxs-lookup"><span data-stu-id="c3c85-403">**pima**: Pointer to the pima class instance</span></span>
- <span data-ttu-id="c3c85-404">**object_handle**: handle dell'oggetto</span><span class="sxs-lookup"><span data-stu-id="c3c85-404">**object_handle**: Handle of the object</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-405">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-405">Example</span></span>
...
## <a name="usb-device-audio-class"></a><span data-ttu-id="c3c85-406">Classe audio dispositivo USB</span><span class="sxs-lookup"><span data-stu-id="c3c85-406">USB Device Audio Class</span></span>

<span data-ttu-id="c3c85-407">La classe audio del dispositivo USB consente a un sistema host USB di comunicare con il dispositivo come dispositivo audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-407">The USB device Audio class allows for a USB host system to communicate with the device as an audio device.</span></span> <span data-ttu-id="c3c85-408">Questa classe è basata sulla classe USB standard e sull'audio USB standard 1,0 o 2,0.</span><span class="sxs-lookup"><span data-stu-id="c3c85-408">This class is based on the USB standard and USB Audio Class 1.0 or 2.0 standard.</span></span>

<span data-ttu-id="c3c85-409">Un Framework di dispositivi conformi all'audio USB deve essere dichiarato dallo stack del dispositivo.</span><span class="sxs-lookup"><span data-stu-id="c3c85-409">A USB audio compliant device framework needs to be declared by the device stack.</span></span> <span data-ttu-id="c3c85-410">Di seguito è riportato un esempio di un altoparlante audio 2,0:</span><span class="sxs-lookup"><span data-stu-id="c3c85-410">An example of an Audio 2.0 speaker follows:</span></span>
...
<span data-ttu-id="c3c85-411">La classe audio usa un Framework per dispositivi composito per raggruppare le interfacce (controllo e flusso).</span><span class="sxs-lookup"><span data-stu-id="c3c85-411">The Audio class uses a composite device framework to group interfaces (control and streaming).</span></span> <span data-ttu-id="c3c85-412">È necessario prestare attenzione quando si definisce il descrittore del dispositivo.</span><span class="sxs-lookup"><span data-stu-id="c3c85-412">As a result care should be taken when defining the device descriptor.</span></span> <span data-ttu-id="c3c85-413">USBX si basa sul descrittore IAD per comprendere internamente come associare le interfacce.</span><span class="sxs-lookup"><span data-stu-id="c3c85-413">USBX relies on the IAD descriptor to know internally how to bind interfaces.</span></span> <span data-ttu-id="c3c85-414">Il descrittore IAD deve essere dichiarato prima delle interfacce (un'interfaccia AudioControl seguita da una o più interfacce AudioStreaming) e contenere la prima interfaccia della classe audio (l'interfaccia AudioControl) e il numero di interfacce associate.</span><span class="sxs-lookup"><span data-stu-id="c3c85-414">The IAD descriptor should be declared before the interfaces (an AudioControl interface followed by one or more AudioStreaming interfaces) and contain the first interface of the Audio class (the AudioControl interface) and how many interfaces are attached.</span></span>

<span data-ttu-id="c3c85-415">Il funzionamento della classe audio varia a seconda che il dispositivo invii o riceva audio, ma in entrambi i casi viene usato un FIFO per l'archiviazione dei buffer del frame audio: se il dispositivo invia audio all'host, l'applicazione aggiunge i buffer del frame audio al FIFO che vengono successivamente inviati all'host da USBX; Se il dispositivo riceve audio dall'host, USBX aggiunge i buffer del frame audio ricevuti dall'host al FIFO, che vengono letti successivamente dall'applicazione.</span><span class="sxs-lookup"><span data-stu-id="c3c85-415">The way the audio class works depends on whether the device is sending or receiving audio, but both cases use a FIFO for storing audio frame buffers: if the device is sending audio to the host, then the application adds audio frame buffers to the FIFO which are later sent to the host by USBX; if the device is receiving audio from the host, then USBX adds the audio frame buffers received from the host to the FIFO which are later read by the application.</span></span> <span data-ttu-id="c3c85-416">Ogni flusso audio ha una propria FIFO e ogni buffer di frame audio è costituito da più esempi.</span><span class="sxs-lookup"><span data-stu-id="c3c85-416">Each audio stream has its own FIFO, and each audio frame buffer consists of multiple samples.</span></span>

<span data-ttu-id="c3c85-417">L'inizializzazione della classe audio prevede le parti seguenti.</span><span class="sxs-lookup"><span data-stu-id="c3c85-417">The initialization of the Audio class expects the following parts.</span></span>

1. <span data-ttu-id="c3c85-418">La classe audio prevede i parametri di flusso seguenti:</span><span class="sxs-lookup"><span data-stu-id="c3c85-418">Audio class expects the following streaming parameters:</span></span>
...
2. <span data-ttu-id="c3c85-419">La classe audio prevede i parametri della funzione seguenti.</span><span class="sxs-lookup"><span data-stu-id="c3c85-419">Audio class expects the following function parameters.</span></span>
   ...
   */
   ...
   <span data-ttu-id="c3c85-420">Il callback della richiesta di controllo definito dall'applicazione (***ux_device_class_audio_control_process***; impostato nell'esempio precedente) viene richiamato quando lo stack riceve una richiesta di controllo dall'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-420">The application-defined control request callback (***ux_device_class_audio_control_process***; set in the previous example) is invoked when the stack receives a control request from the host.</span></span> <span data-ttu-id="c3c85-421">Se la richiesta viene accettata e gestita (riconosciuta o bloccata), il callback deve restituire l'esito positivo; in caso contrario, deve essere restituito Error.</span><span class="sxs-lookup"><span data-stu-id="c3c85-421">If the request is accepted and handled (acknowledged or stalled) the callback must return success, otherwise error should be returned.</span></span>

   <span data-ttu-id="c3c85-422">Il processo di richiesta di controllo specifico della classe è definito come callback definito dall'applicazione, perché le richieste di controllo sono molto diverse tra le versioni audio USB e una parte grande del processo di richiesta si riferisce al Framework del dispositivo.</span><span class="sxs-lookup"><span data-stu-id="c3c85-422">The class-specific control request process is defined as an application-defined callback because the control requests are very different between USB Audio versions and a large part of the request process relates to the device framework.</span></span> <span data-ttu-id="c3c85-423">L'applicazione deve gestire correttamente le richieste per rendere il dispositivo funzionante.</span><span class="sxs-lookup"><span data-stu-id="c3c85-423">The application should handle requests correctly to make the device functional.</span></span>

   <span data-ttu-id="c3c85-424">Poiché per un dispositivo audio, il volume, il mute e la frequenza di campionamento sono richieste di controllo comuni, i callback semplici e definiti internamente per diverse versioni audio USB sono introdotti nelle sezioni successive per l'uso da parte delle applicazioni.</span><span class="sxs-lookup"><span data-stu-id="c3c85-424">Since for an audio device, volume, mute and sampling frequency are common control requests, simple, internally-defined callbacks for different USB audio versions are introduced in later sections for applications to use.</span></span> <span data-ttu-id="c3c85-425">Per altri dettagli, vedere \***ux_device_class_audio10_control_process** _ e _ \*_ux_device_class_audio_control_request_\*\*.</span><span class="sxs-lookup"><span data-stu-id="c3c85-425">Refer to ***ux_device_class_audio10_control_process** _ and _ *_ux_device_class_audio_control_request_** for more details.</span></span>

<span data-ttu-id="c3c85-426">Nel Framework del dispositivo audio il PID/VID viene archiviato nel descrittore del dispositivo (vedere il descrittore del dispositivo dichiarato in precedenza).</span><span class="sxs-lookup"><span data-stu-id="c3c85-426">In the device framework of the Audio device, the PID/VID are stored in the device descriptor (see the device descriptor declared above).</span></span>

<span data-ttu-id="c3c85-427">Quando un sistema host USB individua il dispositivo audio USB e monta la classe audio, il dispositivo può essere usato con qualsiasi lettore audio o registratore (a seconda del Framework).</span><span class="sxs-lookup"><span data-stu-id="c3c85-427">When a USB host system discovers the USB Audio device and mounts the audio class, the device can be used with any audio player or recorder (depending on the framework).</span></span> <span data-ttu-id="c3c85-428">Per informazioni di riferimento, vedere il sistema operativo host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-428">See the host Operating System for reference.</span></span>

<span data-ttu-id="c3c85-429">Le API della classe audio sono definite di seguito.</span><span class="sxs-lookup"><span data-stu-id="c3c85-429">The Audio class APIs are defined below.</span></span>

## <a name="ux_device_class_audio_read_thread_entry"></a><span data-ttu-id="c3c85-430">ux_device_class_audio_read_thread_entry</span><span class="sxs-lookup"><span data-stu-id="c3c85-430">ux_device_class_audio_read_thread_entry</span></span>

<span data-ttu-id="c3c85-431">Voce di thread per la lettura dei dati per la funzione audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-431">Thread entry for reading data for the Audio function.</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-432">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-432">Prototype</span></span>

```C
VOID ux_device_class_audio_read_thread_entry(ULONG audio_stream);
```

### <a name="description"></a><span data-ttu-id="c3c85-433">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-433">Description</span></span>

<span data-ttu-id="c3c85-434">Questa funzione viene passata al parametro di inizializzazione del flusso audio se si desidera leggere l'audio dall'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-434">This function is passed to the audio stream initialization parameter if reading audio from the host is desired.</span></span> <span data-ttu-id="c3c85-435">Internamente, viene creato un thread con questa funzione come funzione di immissione. il thread stesso legge i dati audio tramite l'endpoint di uscita isocrono nella funzione audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-435">Internally, a thread is created with this function as its entry function; the thread itself reads audio data through the isochronous OUT endpoint in the Audio function.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-436">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-436">Parameters</span></span>

- <span data-ttu-id="c3c85-437">**audio_stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-437">**audio_stream**: Pointer to the audio stream instance.</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-438">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-438">Example</span></span>
...
## <a name="ux_device_class_audio_write_thread_entry"></a><span data-ttu-id="c3c85-439">ux_device_class_audio_write_thread_entry</span><span class="sxs-lookup"><span data-stu-id="c3c85-439">ux_device_class_audio_write_thread_entry</span></span>

<span data-ttu-id="c3c85-440">Voce di thread per la scrittura dei dati per la funzione audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-440">Thread entry for writing data for the Audio function</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-441">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-441">Prototype</span></span>

```C
VOID ux_device_class_audio_write_thread_entry(ULONG audio_stream);
```

### <a name="description"></a><span data-ttu-id="c3c85-442">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-442">Description</span></span>

<span data-ttu-id="c3c85-443">Questa funzione viene passata al parametro di inizializzazione del flusso audio se si desidera scrivere l'audio nell'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-443">This function is passed to the audio stream initialization parameter if writing audio to the host is desired.</span></span> <span data-ttu-id="c3c85-444">Internamente, viene creato un thread con questa funzione come funzione di immissione. il thread scrive i dati audio tramite l'endpoint isocrono nella funzione audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-444">Internally, a thread is created with this function as its entry function; the thread itself writes audio data through the isochronous IN endpoint in the Audio function.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-445">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-445">Parameters</span></span>

- <span data-ttu-id="c3c85-446">**audio_stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-446">**audio_stream**: Pointer to the audio stream instance.</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-447">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-447">Example</span></span>
...
## <a name="ux_device_class_audio_stream_get"></a><span data-ttu-id="c3c85-448">ux_device_class_audio_stream_get</span><span class="sxs-lookup"><span data-stu-id="c3c85-448">ux_device_class_audio_stream_get</span></span>

<span data-ttu-id="c3c85-449">Ottenere un'istanza del flusso specifica per la funzione audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-449">Get specific stream instance for the Audio function</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-450">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-450">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-451">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-451">Description</span></span>

<span data-ttu-id="c3c85-452">Questa funzione viene utilizzata per ottenere un'istanza del flusso della classe audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-452">This function is used to get a stream instance of audio class.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-453">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-453">Parameters</span></span>

- <span data-ttu-id="c3c85-454">**audio**: puntatore all'istanza audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-454">**audio**: Pointer to the audio instance</span></span>
- <span data-ttu-id="c3c85-455">**stream_index**: Indice dell'istanza del flusso basato su 0</span><span class="sxs-lookup"><span data-stu-id="c3c85-455">**stream_index**: Stream instance index based on 0</span></span>
- <span data-ttu-id="c3c85-456">**Stream**: puntatore al buffer per archiviare il puntatore dell'istanza del flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-456">**stream**: Pointer to buffer to store the audio stream instance pointer</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-457">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-457">Return Value</span></span>

- <span data-ttu-id="c3c85-458">**UX_SUCCESS** (0x00) questa operazione è riuscita</span><span class="sxs-lookup"><span data-stu-id="c3c85-458">**UX_SUCCESS** (0x00) This operation was successful</span></span>
- <span data-ttu-id="c3c85-459">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-459">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-460">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-460">Example</span></span>
...
## <a name="ux_device_class_audio_reception_start"></a><span data-ttu-id="c3c85-461">ux_device_class_audio_reception_start</span><span class="sxs-lookup"><span data-stu-id="c3c85-461">ux_device_class_audio_reception_start</span></span>

<span data-ttu-id="c3c85-462">Avviare la ricezione di dati audio per il flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-462">Start audio data reception for the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-463">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-463">Prototype</span></span>

```C
UINT ux_device_class_audio_reception_start(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="c3c85-464">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-464">Description</span></span>

<span data-ttu-id="c3c85-465">Questa funzione viene usata per avviare la lettura dei dati audio nei flussi audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-465">This function is used to start audio data reading in audio streams.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-466">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-466">Parameters</span></span>

- <span data-ttu-id="c3c85-467">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-467">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-468">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-468">Return Value</span></span>

- <span data-ttu-id="c3c85-469">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-469">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-470">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-470">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-471">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è pieno.</span><span class="sxs-lookup"><span data-stu-id="c3c85-471">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="c3c85-472">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-472">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-473">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-473">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read8"></a><span data-ttu-id="c3c85-474">ux_device_class_audio_sample_read8</span><span class="sxs-lookup"><span data-stu-id="c3c85-474">ux_device_class_audio_sample_read8</span></span>

<span data-ttu-id="c3c85-475">Leggere l'esempio a 8 bit dal flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-475">Read 8-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-476">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-476">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-477">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-477">Description</span></span>

<span data-ttu-id="c3c85-478">Questa funzione legge i dati di esempio audio a 8 bit dal flusso specificato.</span><span class="sxs-lookup"><span data-stu-id="c3c85-478">This function reads 8-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="c3c85-479">In particolare, legge i dati di esempio dal buffer del frame audio corrente nella FIFO.</span><span class="sxs-lookup"><span data-stu-id="c3c85-479">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="c3c85-480">Dopo aver letto l'ultimo esempio in un frame audio, il frame verrà liberato automaticamente in modo da poter essere usato per accettare più dati dall'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-480">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-481">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-481">Parameters</span></span>

- <span data-ttu-id="c3c85-482">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-482">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="c3c85-483">**buffer**: puntatore al buffer per salvare il byte di esempio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-483">**buffer**: Pointer to the buffer to save sample byte.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-484">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-484">Return Value</span></span>

- <span data-ttu-id="c3c85-485">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-485">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-486">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-486">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-487">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è null.</span><span class="sxs-lookup"><span data-stu-id="c3c85-487">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="c3c85-488">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-488">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-489">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-489">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read16"></a><span data-ttu-id="c3c85-490">ux_device_class_audio_sample_read16</span><span class="sxs-lookup"><span data-stu-id="c3c85-490">ux_device_class_audio_sample_read16</span></span>

<span data-ttu-id="c3c85-491">Leggere l'esempio a 16 bit dal flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-491">Read 16-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-492">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-492">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-493">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-493">Description</span></span>

<span data-ttu-id="c3c85-494">Questa funzione legge i dati di esempio audio a 16 bit dal flusso specificato.</span><span class="sxs-lookup"><span data-stu-id="c3c85-494">This function reads 16-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="c3c85-495">In particolare, legge i dati di esempio dal buffer del frame audio corrente nella FIFO.</span><span class="sxs-lookup"><span data-stu-id="c3c85-495">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="c3c85-496">Dopo aver letto l'ultimo esempio in un frame audio, il frame verrà liberato automaticamente in modo da poter essere usato per accettare più dati dall'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-496">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-497">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-497">Parameters</span></span>

- <span data-ttu-id="c3c85-498">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-498">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="c3c85-499">**buffer**: puntatore al buffer per salvare l'esempio a 16 bit.</span><span class="sxs-lookup"><span data-stu-id="c3c85-499">**buffer**: Pointer to the buffer to save the 16-bit sample.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-500">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-500">Return Value</span></span>

- <span data-ttu-id="c3c85-501">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-501">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-502">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-502">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-503">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è null.</span><span class="sxs-lookup"><span data-stu-id="c3c85-503">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="c3c85-504">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-504">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-505">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-505">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read24"></a><span data-ttu-id="c3c85-506">ux_device_class_audio_sample_read24</span><span class="sxs-lookup"><span data-stu-id="c3c85-506">ux_device_class_audio_sample_read24</span></span>

<span data-ttu-id="c3c85-507">Leggere l'esempio a 24 bit dal flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-507">Read 24-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-508">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-508">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-509">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-509">Description</span></span>

<span data-ttu-id="c3c85-510">Questa funzione legge i dati di esempio audio a 24 bit dal flusso specificato.</span><span class="sxs-lookup"><span data-stu-id="c3c85-510">This function reads 24-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="c3c85-511">In particolare, legge i dati di esempio dal buffer del frame audio corrente nella FIFO.</span><span class="sxs-lookup"><span data-stu-id="c3c85-511">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="c3c85-512">Dopo aver letto l'ultimo esempio in un frame audio, il frame verrà liberato automaticamente in modo da poter essere usato per accettare più dati dall'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-512">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-513">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-513">Parameters</span></span>

- <span data-ttu-id="c3c85-514">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-514">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="c3c85-515">**buffer**: puntatore al buffer per salvare l'esempio a 3 byte.</span><span class="sxs-lookup"><span data-stu-id="c3c85-515">**buffer**: Pointer to the buffer to save the 3-byte sample.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-516">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-516">Return Value</span></span>

- <span data-ttu-id="c3c85-517">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-517">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-518">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-518">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-519">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è null.</span><span class="sxs-lookup"><span data-stu-id="c3c85-519">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="c3c85-520">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-520">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-521">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-521">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read32"></a><span data-ttu-id="c3c85-522">ux_device_class_audio_sample_read32</span><span class="sxs-lookup"><span data-stu-id="c3c85-522">ux_device_class_audio_sample_read32</span></span>

<span data-ttu-id="c3c85-523">Leggere l'esempio a 32 bit dal flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-523">Read 32-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-524">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-524">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-525">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-525">Description</span></span>

<span data-ttu-id="c3c85-526">Questa funzione legge i dati di esempio audio a 32 bit dal flusso specificato.</span><span class="sxs-lookup"><span data-stu-id="c3c85-526">This function reads 32-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="c3c85-527">In particolare, legge i dati di esempio dal buffer del frame audio corrente nella FIFO.</span><span class="sxs-lookup"><span data-stu-id="c3c85-527">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="c3c85-528">Dopo aver letto l'ultimo esempio in un frame audio, il frame verrà liberato automaticamente in modo da poter essere usato per accettare più dati dall'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-528">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-529">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-529">Parameters</span></span>

- <span data-ttu-id="c3c85-530">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-530">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="c3c85-531">**buffer**: puntatore al buffer per salvare i dati a 4 byte.</span><span class="sxs-lookup"><span data-stu-id="c3c85-531">**buffer**: Pointer to the buffer to save the 4-byte data.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-532">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-532">Return Value</span></span>

- <span data-ttu-id="c3c85-533">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-533">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-534">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-534">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-535">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è null.</span><span class="sxs-lookup"><span data-stu-id="c3c85-535">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="c3c85-536">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-536">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-537">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-537">Example</span></span>
...
## <a name="ux_device_class_audio_read_frame_get"></a><span data-ttu-id="c3c85-538">ux_device_class_audio_read_frame_get</span><span class="sxs-lookup"><span data-stu-id="c3c85-538">ux_device_class_audio_read_frame_get</span></span>

<span data-ttu-id="c3c85-539">Ottenere l'accesso al frame audio nel flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-539">Get access to audio frame in the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-540">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-540">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-541">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-541">Description</span></span>

<span data-ttu-id="c3c85-542">Questa funzione restituisce il primo buffer del frame audio e la relativa lunghezza nel FIFO del flusso specificato.</span><span class="sxs-lookup"><span data-stu-id="c3c85-542">This function returns the first audio frame buffer and its length in the specified stream's FIFO.</span></span> <span data-ttu-id="c3c85-543">Al termine dell'elaborazione dei dati da parte dell'applicazione, è necessario utilizzare ux_device_class_audio_read_frame_free per liberare il buffer del frame nel FIFO.</span><span class="sxs-lookup"><span data-stu-id="c3c85-543">When the application is done processing the data, ux_device_class_audio_read_frame_free must be used to free the frame buffer in the FIFO.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-544">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-544">Parameters</span></span>

- <span data-ttu-id="c3c85-545">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-545">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="c3c85-546">**frame_data**: puntatore al puntatore dati in cui restituire il puntatore dati.</span><span class="sxs-lookup"><span data-stu-id="c3c85-546">**frame_data**: Pointer to data pointer to return the data pointer in.</span></span>
- <span data-ttu-id="c3c85-547">**frame_length**: puntatore al buffer per salvare la lunghezza del frame in numero di byte.</span><span class="sxs-lookup"><span data-stu-id="c3c85-547">**frame_length**: Pointer to buffer to save the frame length in number of bytes.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-548">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-548">Return Value</span></span>

- <span data-ttu-id="c3c85-549">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-549">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-550">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-550">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-551">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è null.</span><span class="sxs-lookup"><span data-stu-id="c3c85-551">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="c3c85-552">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-552">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-553">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-553">Example</span></span>
...
## <a name="ux_device_class_audio_read_frame_free"></a><span data-ttu-id="c3c85-554">ux_device_class_audio_read_frame_free</span><span class="sxs-lookup"><span data-stu-id="c3c85-554">ux_device_class_audio_read_frame_free</span></span>

<span data-ttu-id="c3c85-555">Liberare un buffer del frame audio nel flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-555">Free an audio frame buffer in Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-556">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-556">Prototype</span></span>

```C
UINT ux_device_class_audio_read_frame_free(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="c3c85-557">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-557">Description</span></span>

<span data-ttu-id="c3c85-558">Questa funzione libera il buffer del frame audio all'inizio della FIFO del flusso specificato, in modo che possa ricevere dati dall'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-558">This function frees the audio frame buffer at the front of the specified stream's FIFO so that it can receive data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-559">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-559">Parameters</span></span>

- <span data-ttu-id="c3c85-560">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-560">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-561">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-561">Return Value</span></span>

- <span data-ttu-id="c3c85-562">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-562">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-563">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-563">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-564">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è null.</span><span class="sxs-lookup"><span data-stu-id="c3c85-564">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="c3c85-565">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-565">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-566">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-566">Example</span></span>
...
## <a name="ux_device_class_audio_transmission_start"></a><span data-ttu-id="c3c85-567">ux_device_class_audio_transmission_start</span><span class="sxs-lookup"><span data-stu-id="c3c85-567">ux_device_class_audio_transmission_start</span></span>

<span data-ttu-id="c3c85-568">Avviare la trasmissione di dati audio per il flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-568">Start audio data transmission for the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-569">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-569">Prototype</span></span>

```C
UINT ux_device_class_audio_transmission_start(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="c3c85-570">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-570">Description</span></span>

<span data-ttu-id="c3c85-571">Questa funzione viene usata per iniziare a inviare i dati audio scritti nel FIFO nella classe audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-571">This function is used to start sending audio data written to the FIFO in the audio class.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-572">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-572">Parameters</span></span>

- <span data-ttu-id="c3c85-573">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-573">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-574">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-574">Return Value</span></span>

- <span data-ttu-id="c3c85-575">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-575">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-576">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-576">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-577">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è null.</span><span class="sxs-lookup"><span data-stu-id="c3c85-577">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="c3c85-578">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-578">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-579">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-579">Example</span></span>
...
## <a name="ux_device_class_audio_frame_write"></a><span data-ttu-id="c3c85-580">ux_device_class_audio_frame_write</span><span class="sxs-lookup"><span data-stu-id="c3c85-580">ux_device_class_audio_frame_write</span></span>

<span data-ttu-id="c3c85-581">Scrivere un frame audio nel flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-581">Write an audio frame into the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-582">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-582">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-583">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-583">Description</span></span>

<span data-ttu-id="c3c85-584">Questa funzione scrive un frame nel FIFO del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-584">This function writes a frame to the audio stream's FIFO.</span></span> <span data-ttu-id="c3c85-585">I dati del frame vengono copiati nel buffer disponibile nella FIFO in modo che possano essere inviati all'host.</span><span class="sxs-lookup"><span data-stu-id="c3c85-585">The frame data is copied to the available buffer in the FIFO so that it can be sent to the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-586">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-586">Parameters</span></span>

- <span data-ttu-id="c3c85-587">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-587">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="c3c85-588">**frame**: puntatore ai dati del frame.</span><span class="sxs-lookup"><span data-stu-id="c3c85-588">**frame**: Pointer to frame data.</span></span>
- <span data-ttu-id="c3c85-589">**frame_length** Lunghezza del frame in numero di byte.</span><span class="sxs-lookup"><span data-stu-id="c3c85-589">**frame_length** Frame length in number of bytes.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-590">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-590">Return Value</span></span>

- <span data-ttu-id="c3c85-591">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-591">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-592">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-592">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-593">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è pieno.</span><span class="sxs-lookup"><span data-stu-id="c3c85-593">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="c3c85-594">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-594">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-595">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-595">Example</span></span>
...
## <a name="ux_device_class_audio_write_frame_get"></a><span data-ttu-id="c3c85-596">ux_device_class_audio_write_frame_get</span><span class="sxs-lookup"><span data-stu-id="c3c85-596">ux_device_class_audio_write_frame_get</span></span>

<span data-ttu-id="c3c85-597">Ottenere l'accesso al frame audio nel flusso audio</span><span class="sxs-lookup"><span data-stu-id="c3c85-597">Get access to audio frame in the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-598">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-598">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-599">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-599">Description</span></span>

<span data-ttu-id="c3c85-600">Questa funzione recupera l'indirizzo dell'ultimo buffer del frame audio della FIFO; Recupera anche la lunghezza del buffer del frame audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-600">This function retrieves the address of the last audio frame buffer of the FIFO; it also retrieves the length of the audio frame buffer.</span></span> <span data-ttu-id="c3c85-601">Dopo che l'applicazione riempie il buffer del frame audio con i dati desiderati, è necessario usare ***ux_device_class_audio_write_frame_commit*** per aggiungere o eseguire il commit del buffer del frame nel FIFO.</span><span class="sxs-lookup"><span data-stu-id="c3c85-601">After the application fills the audio frame buffer with its desired data, ***ux_device_class_audio_write_frame_commit*** must be used to add/commit the frame buffer to the FIFO.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-602">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-602">Parameters</span></span>

- <span data-ttu-id="c3c85-603">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-603">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="c3c85-604">**frame_data**: puntatore al puntatore ai dati del frame per restituire il puntatore ai dati del frame.</span><span class="sxs-lookup"><span data-stu-id="c3c85-604">**frame_data**: Pointer to frame data pointer to return the frame data pointer in.</span></span>
- <span data-ttu-id="c3c85-605">**frame_length** Puntatore al buffer per salvare la lunghezza del frame in numero di byte.</span><span class="sxs-lookup"><span data-stu-id="c3c85-605">**frame_length** Pointer to the buffer to save frame length in number of bytes .</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-606">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-606">Return Value</span></span>

- <span data-ttu-id="c3c85-607">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-607">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-608">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-608">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-609">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è pieno.</span><span class="sxs-lookup"><span data-stu-id="c3c85-609">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="c3c85-610">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-610">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-611">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-611">Example</span></span>
...
## <a name="ux_device_class_audio_write_frame_commit"></a><span data-ttu-id="c3c85-612">ux_device_class_audio_write_frame_commit</span><span class="sxs-lookup"><span data-stu-id="c3c85-612">ux_device_class_audio_write_frame_commit</span></span>

<span data-ttu-id="c3c85-613">Eseguire il commit di un buffer del frame audio nel flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-613">Commit an audio frame buffer in Audio stream.</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-614">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-614">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-615">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-615">Description</span></span>

<span data-ttu-id="c3c85-616">Questa funzione aggiunge/conferma l'ultimo buffer del frame audio alla FIFO, in modo che il buffer sia pronto per essere trasferito nell'host. Si noti che l'ultimo buffer del frame audio deve essere stato compilato tramite ux_device_class_write_frame_get.</span><span class="sxs-lookup"><span data-stu-id="c3c85-616">This function adds/commits the last audio frame buffer to the FIFO so the buffer is ready to be transferred to host; note the last audio frame buffer should have been filled out via ux_device_class_write_frame_get.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-617">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-617">Parameters</span></span>

- <span data-ttu-id="c3c85-618">**Stream**: puntatore all'istanza del flusso audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-618">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="c3c85-619">**lunghezza**: numero di byte pronti nel buffer.</span><span class="sxs-lookup"><span data-stu-id="c3c85-619">**length**: Number of bytes ready in the buffer.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-620">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-620">Return Value</span></span>

- <span data-ttu-id="c3c85-621">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-621">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-622">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0X51) l'interfaccia è inattiva.</span><span class="sxs-lookup"><span data-stu-id="c3c85-622">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="c3c85-623">Il buffer FIFO **UX_BUFFER_OVERFLOW** (0x5D) è fssull.</span><span class="sxs-lookup"><span data-stu-id="c3c85-623">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is fssull.</span></span>
- <span data-ttu-id="c3c85-624">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-624">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-625">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-625">Example</span></span>
...
## <a name="ux_device_class_audio10_control_process"></a><span data-ttu-id="c3c85-626">ux_device_class_audio10_control_process</span><span class="sxs-lookup"><span data-stu-id="c3c85-626">ux_device_class_audio10_control_process</span></span>

<span data-ttu-id="c3c85-627">Elabora richieste di controllo audio 1,0 USB</span><span class="sxs-lookup"><span data-stu-id="c3c85-627">Process USB Audio 1.0 control requests</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-628">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-628">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="c3c85-629">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-629">Description</span></span>

<span data-ttu-id="c3c85-630">Questa funzione gestisce le richieste di base inviate dall'host nell'endpoint di controllo con un tipo specifico audio 1,0 USB.</span><span class="sxs-lookup"><span data-stu-id="c3c85-630">This function manages basic requests sent by the host on the control endpoint with a USB Audio 1.0 specific type.</span></span>

<span data-ttu-id="c3c85-631">Le funzionalità audio 1,0 delle richieste volume e mute vengono elaborate nella funzione.</span><span class="sxs-lookup"><span data-stu-id="c3c85-631">Audio 1.0 features of volume and mute requests are processed in the function.</span></span> <span data-ttu-id="c3c85-632">Quando si elaborano le richieste, i dati predefiniti passati dall'ultimo parametro (gruppo) vengono usati per rispondere alle richieste e archiviare le modifiche del controllo.</span><span class="sxs-lookup"><span data-stu-id="c3c85-632">When processing the requests, pre-defined data passed by the last parameter (group) is used to answer requests and store control changes.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-633">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-633">Parameters</span></span>

- <span data-ttu-id="c3c85-634">**audio**: puntatore all'istanza audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-634">**audio**: Pointer to the audio instance.</span></span>
- <span data-ttu-id="c3c85-635">**Transfer**: puntatore all'istanza della richiesta di trasferimento.</span><span class="sxs-lookup"><span data-stu-id="c3c85-635">**transfer**: Pointer to the transfer request instance.</span></span>
- <span data-ttu-id="c3c85-636">**gruppo**: gruppo di dati per il processo di richiesta.</span><span class="sxs-lookup"><span data-stu-id="c3c85-636">**group**: Data group for request process.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-637">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-637">Return Value</span></span>

- <span data-ttu-id="c3c85-638">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-638">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-639">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-639">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-640">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-640">Example</span></span>
...
## <a name="ux_device_class_audio20_control_process"></a><span data-ttu-id="c3c85-641">ux_device_class_audio20_control_process</span><span class="sxs-lookup"><span data-stu-id="c3c85-641">ux_device_class_audio20_control_process</span></span>

<span data-ttu-id="c3c85-642">Elabora richieste di controllo audio 1,0 USB</span><span class="sxs-lookup"><span data-stu-id="c3c85-642">Process USB Audio 1.0 control requests</span></span>

### <a name="prototype"></a><span data-ttu-id="c3c85-643">Prototipo</span><span class="sxs-lookup"><span data-stu-id="c3c85-643">Prototype</span></span>
```C
...
### <a name="description"></a><span data-ttu-id="c3c85-644">Descrizione</span><span class="sxs-lookup"><span data-stu-id="c3c85-644">Description</span></span>

<span data-ttu-id="c3c85-645">Questa funzione gestisce le richieste di base inviate dall'host nell'endpoint di controllo con un tipo specifico audio 2,0 USB.</span><span class="sxs-lookup"><span data-stu-id="c3c85-645">This function manages basic requests sent by the host on the control endpoint with a USB Audio 2.0 specific type.</span></span>

<span data-ttu-id="c3c85-646">Frequenza di campionamento audio 2,0 (presunta singola frequenza fissa), le funzionalità delle richieste di volume e di silenziamento vengono elaborate nella funzione.</span><span class="sxs-lookup"><span data-stu-id="c3c85-646">Audio 2.0 sampling rate (assumed single fixed frequency), features of volume and mute requests are processed in the function.</span></span> <span data-ttu-id="c3c85-647">Quando si elaborano le richieste, i dati predefiniti passati dall'ultimo parametro (gruppo) vengono usati per rispondere alle richieste e archiviare le modifiche del controllo.</span><span class="sxs-lookup"><span data-stu-id="c3c85-647">When processing the requests, pre-defined data passed by the last parameter (group) is used to answer requests and store control changes.</span></span>

### <a name="parameters"></a><span data-ttu-id="c3c85-648">Parametri</span><span class="sxs-lookup"><span data-stu-id="c3c85-648">Parameters</span></span>

- <span data-ttu-id="c3c85-649">**audio**: puntatore all'istanza audio.</span><span class="sxs-lookup"><span data-stu-id="c3c85-649">**audio**: Pointer to the audio instance.</span></span>
- <span data-ttu-id="c3c85-650">**Transfer**: puntatore all'istanza della richiesta di trasferimento.</span><span class="sxs-lookup"><span data-stu-id="c3c85-650">**transfer**: Pointer to the transfer request instance.</span></span>
- <span data-ttu-id="c3c85-651">**gruppo**: gruppo di dati per il processo di richiesta.</span><span class="sxs-lookup"><span data-stu-id="c3c85-651">**group**: Data group for request process.</span></span>

### <a name="return-value"></a><span data-ttu-id="c3c85-652">Valore restituito</span><span class="sxs-lookup"><span data-stu-id="c3c85-652">Return Value</span></span>

- <span data-ttu-id="c3c85-653">**UX_SUCCESS** (0x00) questa operazione è stata completata.</span><span class="sxs-lookup"><span data-stu-id="c3c85-653">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="c3c85-654">Errore di **UX_ERROR** (0xFF) dalla funzione</span><span class="sxs-lookup"><span data-stu-id="c3c85-654">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="c3c85-655">Esempio</span><span class="sxs-lookup"><span data-stu-id="c3c85-655">Example</span></span>
