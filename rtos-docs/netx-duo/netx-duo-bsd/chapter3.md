---
title: Capitolo 3 - Azure RTOS servizi BSD netx Duo
description: Questo capitolo contiene una descrizione di tutti i Azure RTOS di base di NetX Duo BSD (elencati di seguito) in ordine alfabetico.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "116791177"
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a>Capitolo 3 - Azure RTOS servizi BSD netx Duo

Questo capitolo contiene una descrizione di tutti i Azure RTOS di base di NetX Duo BSD (elencati di seguito) in ordine alfabetico.
