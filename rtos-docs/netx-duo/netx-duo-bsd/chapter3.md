...
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a>Capitolo 3-servizi BSD di Azure RTO NetX Duo

Questo capitolo contiene una descrizione di tutti i servizi di Azure RTO NetX Duo BSD Basic (elencati di seguito) in ordine alfabetico.
