---
title: Appendice C-tipi di dati di Azure RTO NetX Duo
description: Informazioni sui tipi di dati di Azure RTO NetX Duo.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104822946"
---
# <a name="appendix-c---azure-rtos-snetx-duo-data-types"></a><span data-ttu-id="7a316-103">Appendice C-tipi di dati di Azure RTO sNetX Duo</span><span class="sxs-lookup"><span data-stu-id="7a316-103">Appendix C - Azure RTOS sNetX Duo Data Types</span></span>

## <a name="nx_arp"></a><span data-ttu-id="7a316-104">NX_ARP</span><span class="sxs-lookup"><span data-stu-id="7a316-104">NX_ARP</span></span>
...
```
## <a name="nx_interface"></a><span data-ttu-id="7a316-105">NX_INTERFACE;</span><span class="sxs-lookup"><span data-stu-id="7a316-105">NX_INTERFACE;</span></span>
...
```
## <a name="nx_ip"></a><span data-ttu-id="7a316-106">NX_IP</span><span class="sxs-lookup"><span data-stu-id="7a316-106">NX_IP</span></span>
...
```
## <a name="nx_ip_driver"></a><span data-ttu-id="7a316-107">NX_IP_DRIVER</span><span class="sxs-lookup"><span data-stu-id="7a316-107">NX_IP_DRIVER</span></span>
...
```
## <a name="nx_ip_routing_entry"></a><span data-ttu-id="7a316-108">NX_IP_ROUTING_ENTRY</span><span class="sxs-lookup"><span data-stu-id="7a316-108">NX_IP_ROUTING_ENTRY</span></span>
...
```
## <a name="nx_ipv6_default_router_entry"></a><span data-ttu-id="7a316-109">NX_IPV6_DEFAULT_ROUTER_ENTRY</span><span class="sxs-lookup"><span data-stu-id="7a316-109">NX_IPV6_DEFAULT_ROUTER_ENTRY</span></span>
...
#endif /* FEATURE_NX_IPV6 */
```
## <a name="nx_ipv6_prefix_entry"></a><span data-ttu-id="7a316-110">NX_IPV6_PREFIX_ENTRY</span><span class="sxs-lookup"><span data-stu-id="7a316-110">NX_IPV6_PREFIX_ENTRY</span></span>
...
```
## <a name="nx_packet"></a><span data-ttu-id="7a316-111">NX_PACKET</span><span class="sxs-lookup"><span data-stu-id="7a316-111">NX_PACKET</span></span>
...
```
## <a name="nx_packet_pool"></a><span data-ttu-id="7a316-112">NX_PACKET_POOL</span><span class="sxs-lookup"><span data-stu-id="7a316-112">NX_PACKET_POOL</span></span>
...
```
## <a name="nx_tcp_listen"></a><span data-ttu-id="7a316-113">NX_TCP_LISTEN</span><span class="sxs-lookup"><span data-stu-id="7a316-113">NX_TCP_LISTEN</span></span>
...
```
## <a name="nx_tcp_socket"></a><span data-ttu-id="7a316-114">NX_TCP_SOCKET</span><span class="sxs-lookup"><span data-stu-id="7a316-114">NX_TCP_SOCKET</span></span>
...
```
## <a name="nx_udp_socket"></a><span data-ttu-id="7a316-115">NX_UDP_SOCKET</span><span class="sxs-lookup"><span data-stu-id="7a316-115">NX_UDP_SOCKET</span></span>
...
```
## <a name="nxd_ipv6_address"></a><span data-ttu-id="7a316-116">NXD_IPV6_ADDRESS</span><span class="sxs-lookup"><span data-stu-id="7a316-116">NXD_IPV6_ADDRESS</span></span>
...
```
## <a name="nxd_address"></a><span data-ttu-id="7a316-117">NXD_ADDRESS</span><span class="sxs-lookup"><span data-stu-id="7a316-117">NXD_ADDRESS</span></span>
