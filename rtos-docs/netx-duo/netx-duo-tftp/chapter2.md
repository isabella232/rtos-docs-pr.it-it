...
- **NX_TFTP_SERVER_PRIORITY** Priorità del thread del server TFTP. Per impostazione predefinita, questo valore è definito come 16 per specificare la priorità 16.
