...
---
# <a name="chapter-3---description-of-azure-rtos-netx-duo-autoip-services"></a>Capitolo 3-Descrizione di Azure RTO NetX Duo AutoIP Services

Questo capitolo contiene una descrizione di tutti i servizi AutoIP di Azure RTO NetX Duo (elencati di seguito) in ordine alfabetico.
...
- **NX_AUTO_IP_BAD_INTERFACE_INDEX**: (0xA02) l'interfaccia di rete non è valida NX_PTR_ERROR puntatore AutoIP non valido (0x16).
- NX_CALLER_ERROR: (0x11) il chiamante di questo servizio non è valido.
