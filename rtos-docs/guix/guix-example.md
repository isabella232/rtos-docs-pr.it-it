...
---
# <a name="guix-example"></a><span data-ttu-id="3c8ae-103">Esempio di GUIX</span><span class="sxs-lookup"><span data-stu-id="3c8ae-103">GUIX Example</span></span>

<span data-ttu-id="3c8ae-104">Il sistema dimostrativo GUIX viene fornito con un piccolo esempio, definito in examples/HelloWorld/HelloWorld. c.</span><span class="sxs-lookup"><span data-stu-id="3c8ae-104">The GUIX demonstration system is delivered with a small example, defined in examples/helloworld/helloworld.c.</span></span> <span data-ttu-id="3c8ae-105">In questo esempio vengono illustrati i passaggi necessari per inizializzare il sistema GUIX, per configurare i driver di visualizzazione.</span><span class="sxs-lookup"><span data-stu-id="3c8ae-105">This example illustrates the steps needed to take to initialize the GUIX system, to set up display drivers.</span></span> <span data-ttu-id="3c8ae-106">Il codice sorgente è elencato nelle pagine seguenti.</span><span class="sxs-lookup"><span data-stu-id="3c8ae-106">The source code is listed on the following pages.</span></span>
