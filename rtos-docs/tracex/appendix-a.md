---
title: Appendice A-Sample tx_port. h
description: In questo capitolo viene visualizzato un file tx_port. h di esempio.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104823753"
---
# <a name="appendix-a---sample-tx_porth"></a><span data-ttu-id="2d8db-103">Appendice A-Sample tx_port. h</span><span class="sxs-lookup"><span data-stu-id="2d8db-103">Appendix A - Sample tx_port.h</span></span>

<span data-ttu-id="2d8db-104">In questo capitolo viene visualizzato un file **tx_port. h** di esempio.</span><span class="sxs-lookup"><span data-stu-id="2d8db-104">This chapter displays a sample **tx_port.h** file.</span></span>
