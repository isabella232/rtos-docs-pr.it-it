---
title: Appendice B-il file tx_trace. h
description: In questo capitolo viene visualizzato il file tx_trace. h.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104823732"
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="1acf9-103">Appendice B-il file tx_trace. h</span><span class="sxs-lookup"><span data-stu-id="1acf9-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="1acf9-104">In questo capitolo viene visualizzato il file **tx_trace. h** .</span><span class="sxs-lookup"><span data-stu-id="1acf9-104">This chapter displays the **tx_trace.h** file.</span></span>
